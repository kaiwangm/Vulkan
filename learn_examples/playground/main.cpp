...
public:
	...
	void initResources(VkRenderPass renderPass, VkQueue copyQueue, const std::string& shadersPath)
	{
		...
		shaderStages[0] = example->loadShader("shaders/playground/ui.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = example->loadShader("shaders/playground/ui.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
...
public:
	...
	void preparePipelines()
	{
		...
		shaderStages[0] = loadShader("shaders/playground/scene.vert.spv", VK_SHADER_STAGE_VERTEX_BIT);
		shaderStages[1] = loadShader("shaders/playground/scene.frag.spv", VK_SHADER_STAGE_FRAGMENT_BIT);
